...
function addClouds(scene) {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    sprite.position.set((Math.random() - 0.5) * 80, 12 + Math.random() * 8, -18 - Math.random() * 28);
    scene.add(sprite);
...
function addIslands(scene) {
  [
    buildIsland(-26, -34, 3.2, "#3e5c52"),
    buildIsland(20, -30, 2.4, "#4a6b5e"),
    buildIsland(34, -16, 1.8, "#3e5c52")
